...
#ifndef COMMS_BRIDGE_RAPID_ADVERTISEMENT_INFO_H_
#define COMMS_BRIDGE_RAPID_ADVERTISEMENT_INFO_H_
...
class RapidAdvertisementInfo : public GenericRapidSub {
 public:
  RapidAdvertisementInfo(const std::string& subscribe_topic,
   ...
   */
  void operator() (rapid::ext::astrobee::GenericCommsAdvertisementInfo const* data);
...
#endif  // COMMS_BRIDGE_RAPID_ADVERTISEMENT_INFO_H_
