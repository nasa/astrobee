...
#ifndef DDS_ROS_BRIDGE_RAPID_EKF_ROS_EKF_H_
#define DDS_ROS_BRIDGE_RAPID_EKF_ROS_EKF_H_
...
class RapidEkfToRos : public RapidSubRosPub {
 public:
  RapidEkfToRos(const std::string& subscribe_topic,
                          const std::string& subscribe_partition,
                          const std::string& pub_topic,
                          const ros::NodeHandle &nh,
                          const unsigned int queue_size = 10);
  void CopyTransform3D(const rapid::Transform3D& transform,
...
#endif  // DDS_ROS_BRIDGE_RAPID_EKF_ROS_EKF_H_
