...
#ifndef LOCALIZATION_ANALYSIS_SPARSE_MAPPING_POSE_ADDER_H_
#define LOCALIZATION_ANALYSIS_SPARSE_MAPPING_POSE_ADDER_H_
...
#endif  // LOCALIZATION_ANALYSIS_SPARSE_MAPPING_POSE_ADDER_H_
