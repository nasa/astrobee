...
parser.add_argument(
    "--splices", "-s", nargs="+", type=str, help="number of each splice"
)

parser.add_argument(
    "--directory", "-d", type=str, help="full path to the dirdectory that holds all the ground truth directories for splices of the bag"
)

parser.add_argument(
    "--bag","-b", type=str, help="put the name of the bag up to the part where the number of the splice is"
)
...
colmap = "/srv/novus_1/cmason9/colmap/build/src/exe/colmap"
error_bags = []
...
for splice in splices:
    counter = 0
    bag_directory = directory + "/" + baggy + splice
    mapping_pose = []
    images_path = bag_directory+ "/bag_images_" + baggy + splice
    timestamps = []
    ...
    bag_path = bag_directory + "/" + baggy + splice
    ...
    images_path = input_directory + "/bag_images_" + baggy + splice
