...
def save_rmse_stats_to_plot(
    pdf, rmses, prefix="", label_1="", rmses_2=None, label_2=""
):
    # Plot mean rmses
    (
        mean_rmses,
        ...
        relative_rmses,
        relative_change_in_rmses,
    ) = save_rmse_results_to_csv(rmses, prefix, rmses_2, label_1, label_2)
    ...
    if len(mean_rmses) > 1:
        ...
        relative_rmses_change_string = (
            prefix + "rel change in rmse %: " + str(100 * relative_change_in_rmses[0])
        )
...
def create_plot(
    output_file, csv_file, label_1="", csv_file_2=None, label_2="", imu_augmented_2=True
):
    ...
    rel_imu_augmented_orientation_rmses = dataframe[
        "rel_imu_augmented_orientation_rmse"
    ]
    ...
    rel_imu_bias_tester_orientation_rmses = dataframe[
        "rel_imu_bias_tester_orientation_rmse"
    ]
    ...
    if csv_file_2:
        ...
        if imu_augmented_2:
            ...
            imu_augmented_integrated_rmses_2 = dataframe_2[
                "imu_augmented_integrated_rmse"
            ]
            rel_imu_augmented_integrated_rmses_2 = dataframe_2[
                "rel_imu_augmented_integrated_rmse"
            ]
            imu_augmented_orientation_rmses_2 = dataframe_2[
                "imu_augmented_orientation_rmse"
            ]
            rel_imu_augmented_orientation_rmses_2 = dataframe_2[
                "rel_imu_augmented_orientation_rmse"
            ]
            # IMU bias tester rmses
            imu_bias_tester_rmses_2 = dataframe_2["imu_bias_tester_rmse"]
            rel_imu_bias_tester_rmses_2 = dataframe_2["rel_imu_bias_tester_rmse"]
            imu_bias_tester_orientation_rmses_2 = dataframe_2[
    ...
    with PdfPages(output_file) as pdf:
        ...
        rmse_plots(
            ...
            shortened_bag_names,
            rel_rmses,
            rel_integrated_rmses,
            rel_orientation_rmses,
            "rel",
            label_1,
            rel_rmses_2,
            rel_integrated_rmses_2,
            rel_orientation_rmses_2,
            label_2,
        )
        if imu_augmented_2:
            rmse_plots(
                ...
                shortened_bag_names,
                imu_augmented_rmses,
                imu_augmented_integrated_rmses,
            ...
            rmse_plots(
                ...
                x_axis_vals,
                shortened_bag_names,
                rel_imu_augmented_rmses,
                rel_imu_augmented_integrated_rmses,
                rel_imu_augmented_orientation_rmses,
                "rel_imu_augmented",
                label_1,
                rel_imu_augmented_rmses_2,
                rel_imu_augmented_integrated_rmses_2,
                rel_imu_augmented_orientation_rmses_2,
                label_2,
            )
            rmse_plots(
                pdf,
                x_axis_vals,
                shortened_bag_names,
                imu_bias_tester_rmses,
                None,
                imu_bias_tester_orientation_rmses,
                "imu_bias_tester",
                label_1,
                imu_bias_tester_rmses_2,
                None,
            ...
            rmse_plots(
                ...
                x_axis_vals,
                shortened_bag_names,
                rel_imu_bias_tester_rmses,
                None,
                rel_imu_bias_tester_orientation_rmses,
                "rel_imu_bias_tester",
                label_1,
                rel_imu_bias_tester_rmses_2,
                None,
                rel_imu_bias_tester_orientation_rmses_2,
                label_2,
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--label1", default="", help="Optional label for first csv file"
    )
    parser.add_argument(
        "--label2", default="", help="Optional label for second csv file"
    )
    parser.add_argument(
        "--no-imu-augmented2", dest="imu_augmented2", action="store_false"
    )
