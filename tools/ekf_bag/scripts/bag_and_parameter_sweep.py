...
def bag_and_parameter_sweep(bag_files, output_dir, map_file, image_topic, gnc_config):
  for bag_file in bag_files:
    ...
    parameter_sweep.make_values_and_parameter_sweep(bag_output_dir, bag_file, map_file, image_topic, gnc_config)
...
if __name__ == '__main__':
  ...
  bag_and_parameter_sweep(bag_files, output_dir, args.map_file, args.image_topic, args.gnc_config)
