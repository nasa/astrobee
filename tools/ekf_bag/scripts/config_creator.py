...
def fill_in_values(original_gnc_config, value_map, new_gnc_config):
  original_config_file = open(original_gnc_config, 'r')
  new_config_file = open(new_gnc_config, 'w')
...
def make_config(values, value_names, original_gnc_config, new_gnc_config):
  value_map = make_value_map(values, value_names)
  fill_in_values(original_gnc_config, value_map, new_gnc_config)
