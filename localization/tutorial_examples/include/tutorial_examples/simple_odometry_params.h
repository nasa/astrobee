...
#ifndef TUTORIAL_EXAMPLES_SIMPLE_ODOMETRY_PARAMS_H_
#define TUTORIAL_EXAMPLES_SIMPLE_ODOMETRY_PARAMS_H_
...
struct SimpleOdometryParams {
  ...
  SimpleOdometryParams() {
    // Factor Adder
    relative_pose_factor_adder.enabled = true;
    relative_pose_factor_adder.huber_k = 1.345;
    // Node Adder
    combined_nav_state_node_adder.huber_k = 1.345;
    combined_nav_state_node_adder.add_priors = true;
    combined_nav_state_node_adder.starting_time = 0.0;
    combined_nav_state_node_adder.ideal_duration = 10.0;
    combined_nav_state_node_adder.min_num_states = 2;
    combined_nav_state_node_adder.max_num_states = 20;
    // Node Adder Model
    ...
    combined_nav_state_node_adder_model.imu_integrator
      .gyro_bias_sigma = 0.01;
    combined_nav_state_node_adder_model.imu_integrator
      .integration_variance = 0.01;
    combined_nav_state_node_adder_model.imu_integrator
      .bias_acc_omega_int = 0.01;
    // Nonlinear Optimizer
  ...
  node_adders::TimestampedNodeAdderParams<
    ...
    combined_nav_state_node_adder;
  node_adders::CombinedNavStateNodeAdderModel::Params
    combined_nav_state_node_adder_model;
...
#endif  // TUTORIAL_EXAMPLES_SIMPLE_ODOMETRY_PARAMS_H_
