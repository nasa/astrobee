...
#ifndef GRAPH_FACTORS_POINT_TO_HANDRAIL_ENDPOINT_FACTOR_H_
#define GRAPH_FACTORS_POINT_TO_HANDRAIL_ENDPOINT_FACTOR_H_
...
#endif  // GRAPH_FACTORS_POINT_TO_HANDRAIL_ENDPOINT_FACTOR_H_
