 ...
 * under the License.
 */
#ifndef ROS_GRAPH_LOCALIZER_ROS_GRAPH_LOCALIZER_VIO_NODELET_H_
#define ROS_GRAPH_LOCALIZER_ROS_GRAPH_LOCALIZER_VIO_NODELET_H_
...
class RosGraphLocalizerVIONodelet : public ff_util::FreeFlyerNodelet {
 public:
  RosGraphLocalizerVIONodelet();
 ...
 private:
  ...
  bool ResetBiasesAndLocalizerVIO(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res);

  bool ResetBiasesFromFileAndResetLocalizerVIO(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res);

  bool ResetBiasesFromFileAndResetLocalizerVIO();
  ...
  ros_graph_vio::RosGraphVIONodeletParams vio_params_;
  int last_mode_ = -1;
...
#endif  // ROS_GRAPH_LOCALIZER_ROS_GRAPH_LOCALIZER_VIO_NODELET_H_
