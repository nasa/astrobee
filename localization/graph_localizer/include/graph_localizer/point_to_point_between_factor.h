...
#ifndef GRAPH_LOCALIZER_POINT_TO_POINT_BETWEEN_FACTOR_H_
#define GRAPH_LOCALIZER_POINT_TO_POINT_BETWEEN_FACTOR_H_
...
#endif  // GRAPH_LOCALIZER_POINT_TO_POINT_BETWEEN_FACTOR_H_
