...
class GraphLocalizerNodelet : public ff_util::FreeFlyerNodelet {
 ...
 private:
  ...
  ros::Subscriber imu_sub_, of_sub_, vl_sub_, ar_sub_, sm_sub_, dl_sub_, depth_odometry_sub_, flight_mode_sub_;
  ros::Publisher state_pub_, graph_pub_, ar_tag_pose_pub_, handrail_pose_pub_, sparse_mapping_pose_pub_,
    reset_pub_, heartbeat_pub_;
