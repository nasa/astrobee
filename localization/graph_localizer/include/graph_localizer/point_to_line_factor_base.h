...
#ifndef GRAPH_LOCALIZER_POINT_TO_LINE_FACTOR_BASE_H_
#define GRAPH_LOCALIZER_POINT_TO_LINE_FACTOR_BASE_H_
...
#endif  // GRAPH_LOCALIZER_POINT_TO_LINE_FACTOR_BASE_H_
