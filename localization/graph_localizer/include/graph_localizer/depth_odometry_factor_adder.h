...
class DepthOdometryFactorAdder
  ...
  using Base =
    graph_optimizer::FactorAdder<localization_measurements::DepthOdometryMeasurement, DepthOdometryFactorAdderParams>;

 public:
  explicit DepthOdometryFactorAdder(const DepthOdometryFactorAdderParams& params);
