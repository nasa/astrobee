...
ButterworthLowpassFilter20_83_Notch::ButterworthLowpassFilter20_83_Notch() : initialized_(false) {}

void ButterworthLowpassFilter20_83_Notch::Initialize(const double first_value, const double gain) {
...
double ButterworthLowpassFilter20_83_Notch::AddValue(const double value) {
  ...
  static constexpr double GAIN = 2.2743339590e+01;
  ...
  yv_[2] = yv_[3];
  // Generate new output
  yv_[3] = (xv_[0] + xv_[3]) + 1.9999996372 * (xv_[1] + xv_[2]) + (-0.0000000000 * yv_[0]) + (-0.0000000000 * yv_[1]) +
           (0.7361865327 * yv_[2]);
