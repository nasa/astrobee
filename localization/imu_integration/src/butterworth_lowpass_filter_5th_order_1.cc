...
ButterworthLowpassFilter5thOrder1::ButterworthLowpassFilter5thOrder1() : initialized_(false) {}

void ButterworthLowpassFilter5thOrder1::Initialize(const double first_value, const double gain) {
...
double ButterworthLowpassFilter5thOrder1::AddValue(const double value) {
