 ...
 * under the License.
 */
#ifndef VISION_COMMON_BRISK_FEATURE_DETECTOR_AND_MATCHER_H_
#define VISION_COMMON_BRISK_FEATURE_DETECTOR_AND_MATCHER_H_
...
#endif  // VISION_COMMON_BRISK_FEATURE_DETECTOR_AND_MATCHER_H_
