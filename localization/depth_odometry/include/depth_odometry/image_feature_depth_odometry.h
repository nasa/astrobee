 ...
 * under the License.
 */
#ifndef DEPTH_ODOMETRY_IMAGE_FEATURE_DEPTH_ODOMETRY_H_
#define DEPTH_ODOMETRY_IMAGE_FEATURE_DEPTH_ODOMETRY_H_

#include <depth_odometry/depth_odometry.h>

namespace depth_odometry {
class ImageFeatureDepthOdometry : public DepthOdometry {
 public:
...
#endif  // DEPTH_ODOMETRY_IMAGE_FEATURE_DEPTH_ODOMETRY_H_
