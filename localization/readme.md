...
* Ryan Soussan, Marina Moreira, Brian Coltin, and Trey Smith, "AstroLoc2: Fast Sequential Depth-Enhanced Localization for Free-Flying Robots", Int. Conf. on Robotics and Automation (ICRA), 2025. [Link](https://ieeexplore.ieee.org/abstract/document/11128673 "Link") [PDF](https://ntrs.nasa.gov/api/citations/20250001870/downloads/astroloc2_final.pdf "PDF")
