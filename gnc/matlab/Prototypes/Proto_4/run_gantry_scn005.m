...
%% Post Process Data
dlmwrite('gantry_scn005.csv', [out_ctl_msg.body_accel_cmd.time, out_ctl_msg.body_accel_cmd.data, out_ctl_msg.body_alpha_cmd.data])
save gantry_scn005_truth out_env_msg
