...
{'traj_alpha', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
  ...
  { ... 
    ...
    'Auto', ... 
    '-1', {... 
{'est_quat_ISS2B', 4, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'est_omega_B_ISS_B', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'est_V_B_ISS_ISS', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'est_P_B_ISS_ISS', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'est_confidence', 1, 'uint8', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'cmd_state_a', 1, 'Bus: cmc_state_cmd', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'cmd_state_b', 1, 'Bus: cmc_state_cmd', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'ctl_mode_cmd', 1, 'uint8', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'current_time_sec', 1, 'uint32', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'current_time_nsec', 1, 'uint32', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'speed_gain_cmd', 1, 'uint8', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'att_kp', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'att_ki', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
{'omega_kd', 3, 'single', -1, 'real', 'Sample', 'Fixed', [], [], '', ''}; ...
