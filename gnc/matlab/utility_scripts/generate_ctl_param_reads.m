...
%% Inputs
source_header = 'ctl_controller0.h';
...
output_fname = 'ctl_tunable_funcs';
function_name = 'ctl_ReadParams';
input_object_type = 'RT_MODEL_ctl_controller0_T*';
input_object_name = 'ctl';
