...
boolean_exceptions = {'tun_ctl_bypass_cmd_shaper', 'tun_cvs_noise_on', ...
                    ...
                    'tun_debug_ctl_use_truth', 'tun_ase_enable_of', 'tun_ase_gravity_removal'};
output_fname = 'est_tunable_funcs';
function_name = 'est_ReadParams';
input_object_type = 'RT_MODEL_est_estimator_T*';
input_object_name = 'est';
