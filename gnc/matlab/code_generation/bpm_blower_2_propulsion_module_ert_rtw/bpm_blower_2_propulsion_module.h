//
// File: bpm_blower_2_propulsion_module.h
//
...
//
#ifndef RTW_HEADER_bpm_blower_2_propulsion_module_h_
#define RTW_HEADER_bpm_blower_2_propulsion_module_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef bpm_blower_2_propulsion_module_COMMON_INCLUDES_
# define bpm_blower_2_propulsion_module_COMMON_INCLUDES_
#include <stdlib.h>
#include "rtwtypes.h"
#endif                                 // bpm_blower_2_propulsion_module_COMMON_INCLUDES_ 

#include "bpm_blower_2_propulsion_module_types.h"
...
typedef struct {
  ...
  real_T NextOutput_p;                 // '<S8>/random_noise'
...
} DW_bpm_blower_2_propulsion_mo_T;

// Parameters for system: '<S15>/CoreSubsys'
struct P_CoreSubsys_bpm_blower_2_pro_T_ {
...
struct P_bpm_blower_2_propulsion_mod_T_ {
  ...
  real32_T DiscretePIDController_LowerSa_d;// Mask Parameter: DiscretePIDController_LowerSa_d
                                           //  Referenced by:
                                           //    '<S33>/Saturate'
                                           //    '<S34>/DeadZone'
  ...
  P_CoreSubsys_bpm_blower_2_pro_T CoreSubsys;// '<S15>/CoreSubsys'
  P_blower_aerodynamics_bpm_blo_T blower_aerodynamics;// '<S1>/blower_aerodynamics' 
};

// Real-time Model Data Structure
struct tag_RTM_bpm_blower_2_propulsi_T {
  const char_T * volatile errorStatus;
  B_bpm_blower_2_propulsion_mod_T *blockIO;
  P_bpm_blower_2_propulsion_mod_T *defaultParam;
  boolean_T paramIsMalloced;
  DW_bpm_blower_2_propulsion_mo_T *dwork;
};
...
extern P_bpm_blower_2_propulsion_mod_T bpm_blower_2_propulsion_modul_P;// parameters 
...
extern "C" {
  ...
  extern RT_MODEL_bpm_blower_2_propuls_T *bpm_blower_2_propulsion_module
    (real32_T *bpm_blower_2_propulsion_modul_U_battery_voltage, real32_T
  ...
  extern void bpm_blower_2_propulsion_module_initialize
    (RT_MODEL_bpm_blower_2_propuls_T *const bpm_blower_2_propulsion_modu_M,
     real32_T *bpm_blower_2_propulsion_modul_U_battery_voltage, real32_T
     bpm_blower_2_propulsion_modul_U_omega_B_ECI_B[3], uint8_T
     *bpm_blower_2_propulsion_modul_U_impeller_cmd, real32_T
     bpm_blower_2_propulsion_modul_U_servo_cmd[6], real32_T
     ...
     *bpm_blower_2_propulsion_modul_Y_motor_speed, real32_T
     bpm_blower_2_propulsion_modul_Y_nozzle_theta[6], real32_T
     *bpm_blower_2_propulsion_modul_Y_meas_motor_speed);
  extern void bpm_blower_2_propulsion_module_step
    (RT_MODEL_bpm_blower_2_propuls_T *const bpm_blower_2_propulsion_modu_M,
     real32_T bpm_blower_2_propulsion_modul_U_battery_voltage, real32_T
     bpm_blower_2_propulsion_modul_U_omega_B_ECI_B[3], uint8_T
     bpm_blower_2_propulsion_modul_U_impeller_cmd, real32_T
     ...
     *bpm_blower_2_propulsion_modul_Y_motor_speed, real32_T
     bpm_blower_2_propulsion_modul_Y_nozzle_theta[6], real32_T
     *bpm_blower_2_propulsion_modul_Y_meas_motor_speed);
  extern void bpm_blower_2_propulsion_module_terminate
...
//
//  hilite_system('astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module')    - opens subsystem astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module
//  hilite_system('astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/Kp') - opens and selects block Kp
//
//  Here is the system hierarchy for this model
//
//  '<Root>' : 'astrobee/sim_model_lib/veh_vehicle_model'
//  '<S1>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module'
//  '<S2>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_aerodynamics'
//  '<S3>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics'
//  '<S4>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/calc_nozzle_area'
//  '<S5>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/impeller_model'
//  '<S6>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/motor_rotational_dynamics'
//  '<S7>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/servo_model'
//  '<S8>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/speed_sensor'
//  '<S9>'   : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/Detect Change'
//  '<S10>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/cross_product'
//  '<S11>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies'
//  '<S12>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/vector_normalize'
//  '<S13>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/cross_product/skew_symetric_matrix_operator'
//  '<S14>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/cross_product/skew_symetric_matrix_operator/Data Type Conversion Inherited'
//  '<S15>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem'
//  '<S16>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/MATLAB Function'
//  '<S17>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem/rotate_vec_A2B'
//  '<S18>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem/rotate_vec_A2B/quaternion_to_DCM'
//  '<S19>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem/rotate_vec_A2B/quaternion_to_DCM/Data Type Conversion Inherited'
//  '<S20>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem/rotate_vec_A2B/quaternion_to_DCM/Data Type Conversion Inherited1'
//  '<S21>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem/rotate_vec_A2B/quaternion_to_DCM/skew_symetric_matrix_operator'
//  '<S22>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/latch_nozzle_thrust_matricies/For Each Subsystem/rotate_vec_A2B/quaternion_to_DCM/skew_symetric_matrix_operator/Data Type Conversion Inherited'
//  '<S23>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/vector_normalize/No-op'
//  '<S24>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/vector_normalize/Normalize'
//  '<S25>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/blower_body_dynamics/vector_normalize/vector_magnitude'
//  '<S26>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/impeller_model/dc_motor_model'
//  '<S27>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/impeller_model/speed_controller'
//  '<S28>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/impeller_model/speed_controller/Discrete PID Controller'
//  '<S29>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/impeller_model/speed_controller/Saturation Dynamic'
//  '<S30>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/impeller_model/speed_controller/Discrete PID Controller/Clamping circuit'
//  '<S31>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/servo_model/dc_motor_dynamics'
//  '<S32>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/servo_model/servo_controller'
//  '<S33>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/servo_model/servo_controller/Discrete PID Controller'
//  '<S34>'  : 'astrobee/sim_model_lib/veh_vehicle_model/bpm_blower_2_propulsion_module/servo_model/servo_controller/Discrete PID Controller/Clamping circuit'

#endif                                 // RTW_HEADER_bpm_blower_2_propulsion_module_h_ 
