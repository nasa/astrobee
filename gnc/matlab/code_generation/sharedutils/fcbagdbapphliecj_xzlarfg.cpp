//
// File: fcbagdbapphliecj_xzlarfg.cpp
//
  ...
  int32_T ix0)
{
  ...
  tau = 0.0F;
  if (!(n <= 0)) {
    xnorm = dbielngdhlfkohdb_xnrm2((int32_T)(n - 1), x_data, ix0);
    if (xnorm != 0.0F) {
      ...
      if ((real32_T)fabs((real_T)xnorm) < 9.86076132E-32F) {
        ...
        xnorm = rt_hypotf_snf(*alpha1, dbielngdhlfkohdb_xnrm2((int32_T)(n - 1),
          x_data, ix0));
        if (*alpha1 >= 0.0F) {
          xnorm = -xnorm;
        }
