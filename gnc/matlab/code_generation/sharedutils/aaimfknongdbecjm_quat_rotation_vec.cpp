//
// File: aaimfknongdbecjm_quat_rotation_vec.cpp
//
...
//
#include "rtwtypes.h"
#include "aaimfknongdbecjm_quat_rotation_vec.h"

// Function for MATLAB Function: '<S17>/Compute Residual and H'
void aaimfknongdbecjm_quat_rotation_vec(const real_T vector[3], const real32_T
