...
/* simple_dae_impl_ode_fun_jac_x_xdot_u:(i0[2],i1[2],i2[2],i3[2],i4[])->(o0[4],o1[4x2,4nz],o2[4x2,2nz],o3[4x2,2nz]) */
...
CASADI_SYMBOL_EXPORT casadi_int simple_dae_impl_ode_fun_jac_x_xdot_u_n_in(void) { return 5;}
