...
static const casadi_int casadi_s4[9] = {4, 2, 0, 2, 4, 1, 2, 0, 3};

/* simple_dae_impl_ode_jac_x_xdot_u_z:(i0[2],i1[2],i2[2],i3[2],i4[])->(o0[4x2,4nz],o1[4x2,2nz],o2[4x2,2nz],o3[4x2,4nz]) */
...
CASADI_SYMBOL_EXPORT casadi_int simple_dae_impl_ode_jac_x_xdot_u_z_n_in(void) { return 5;}
