...
/* vde_adj_chain_nm5:(i0[24],i1[24],i2[3])->(o0[27]) */
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm5(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem){
...
CASADI_SYMBOL_EXPORT casadi_int vde_adj_chain_nm5_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT casadi_int vde_adj_chain_nm5_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT const char* vde_adj_chain_nm5_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* vde_adj_chain_nm5_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* vde_adj_chain_nm5_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* vde_adj_chain_nm5_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int vde_adj_chain_nm5_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 3;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
