...
#else
  #define CASADI_PREFIX(ID) chain_nm_4_external_cost_ ## ID
#endif
...
/* chain_nm_4_external_cost:(i0[18],i1[3])->(o0,o1[21],o2[21x21,21nz]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem) {
  ...
  a6=arg[0] ? arg[0][0] : 0;
  a7=3.3223279999999999e-01;
  a6=(a6-a7);
  a7=casadi_sq(a6);
  a7=(a5*a7);
  a2=(a2+a7);
  a7=arg[0] ? arg[0][1] : 0;
  a8=-1.2219330000000000e-19;
  a7=(a7-a8);
  a8=casadi_sq(a7);
  a8=(a5*a8);
  a2=(a2+a8);
  a8=arg[0] ? arg[0][2] : 0;
  a9=-2.5038329999999998e-01;
  a8=(a8-a9);
  a9=casadi_sq(a8);
  a9=(a5*a9);
  a2=(a2+a9);
  ...
  a2=(a2+a12);
  a12=arg[0] ? arg[0][6] : 0;
  a13=6.7041680000000003e-01;
  a12=(a12-a13);
  a13=casadi_sq(a12);
  a13=(a5*a13);
  a2=(a2+a13);
  a13=arg[0] ? arg[0][7] : 0;
  a14=-2.4657539999999999e-19;
  a13=(a13-a14);
  a14=casadi_sq(a13);
  a14=(a5*a14);
  a2=(a2+a14);
  a14=arg[0] ? arg[0][8] : 0;
  a15=-1.7986940000000001e-01;
  a14=(a14-a15);
  a15=casadi_sq(a14);
  a15=(a5*a15);
  a2=(a2+a15);
  a15=arg[0] ? arg[0][9] : 0;
  a16=-1.3347779999999999e-31;
  a15=(a15-a16);
  a16=casadi_sq(a15);
  a16=(a5*a16);
  a2=(a2+a16);
  a16=arg[0] ? arg[0][10] : 0;
  a17=-2.7046330000000000e-44;
  a16=(a16-a17);
  a17=casadi_sq(a16);
  a17=(a5*a17);
  a2=(a2+a17);
  a17=arg[0] ? arg[0][11] : 0;
  a18=-1.3618550000000001e-43;
  a17=(a17-a18);
  a18=casadi_sq(a17);
  a18=(a5*a18);
  a2=(a2+a18);
  a18=arg[0] ? arg[0][12] : 0;
  a19=9.9772959999999999e-01;
  a18=(a18-a19);
  a19=casadi_sq(a18);
  a19=(a5*a19);
  a2=(a2+a19);
  a19=arg[0] ? arg[0][13] : 0;
  a20=-3.6695910000000002e-19;
  a19=(a19-a20);
  a20=casadi_sq(a19);
  a20=(a5*a20);
  a2=(a2+a20);
  a20=arg[0] ? arg[0][14] : 0;
  a21=2.0330019999999999e-01;
  a20=(a20-a21);
  a21=casadi_sq(a20);
  a21=(a5*a21);
  a2=(a2+a21);
...
CASADI_SYMBOL_EXPORT int chain_nm_4_external_cost(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT void chain_nm_4_external_cost_incref(void) {
}

CASADI_SYMBOL_EXPORT void chain_nm_4_external_cost_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int chain_nm_4_external_cost_n_in(void) { return 2;}

CASADI_SYMBOL_EXPORT casadi_int chain_nm_4_external_cost_n_out(void) { return 3;}

CASADI_SYMBOL_EXPORT const char* chain_nm_4_external_cost_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const char* chain_nm_4_external_cost_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    case 2: return "o2";
...
CASADI_SYMBOL_EXPORT const casadi_int* chain_nm_4_external_cost_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* chain_nm_4_external_cost_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int chain_nm_4_external_cost_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 2;
  if (sz_res) *sz_res = 3;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
