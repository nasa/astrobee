...
Tool: ~/coverage_analysis/img2bag.py
Outputs: bagOfTheMap.bag
 
Move all the image files used to generate the map to a single directory
Run "python img2bag.py /dir/where/jpgs/are /dir/where/bag/should/go/bagOfTheMap.bag", bagOfTheMap.bag = 20210518_cabanel.bag
...
Tools: roslaunch, rosservice, ~/coverage_analysis/activity_DBGenerator.py, rosbag play
Outputs: activity_database_file with recommended naming convention "YYYYMMdd_activity_db.csv" (The coordinates in the CSV output file are in the Astrobee's body inertial frame already).

Follow the instructions in ~/astrobee/localization/sparse_mapping/build_map.md for "Verify localization against a sparse map on a local machine"
...
"python ~/coverage_analysis/activity_DBGenerator.py <activity name> <activity date> <activity_database_file>", where
activity name = KiboEventRehRun1
activity date = 2021-07-26
activity_database_file = /dir/where/database/file/will/be/20210726_dali_KiboEvRhRun1_db.csv
...
Tools: ~/code/python/coverage_Painter.py, roslaunch
...
In another terminal run 
  "python ~/coverage/anaylisis/coverage_Painter.py <activity_coverage_database_file> map_coverage" where
...
Inputs: activity_coverage_database_file = /dir/where/results/are/going/to/be/placed/20210518_cabanel_coverage_db.csv or /dir/where/results/are/going/to/be/placed/20210726_dali_KiboEvRhRun1_db.csv
Tools: ~/code/python/coverage_StatsReporter.py
Outputs: CSV and PDF Stats reports 
(CSV: /dir/where/results/are/going/to/be/placed/20210707_dali_coverage_db_stats.csv or /dir/where/results/are/going/to/be/placed/20210726_dali_KiboEvRhRun1_coverage_db_stats.csv)
(PDF: /dir/where/results/are/going/to/be/placed/20210707_dali_coverage_db_stats_report.pdf or /dir/where/results/are/going/to/be/placed/20210726_dali_KiboEvRhRun1_coverage_db_stats_report.pdf)
...
In a terminal run
 "python ~/coverage_analysis/coverage_StatsReporter.py <activity_coverage_database_file>" where 
activity_coverage_database_file = /dir/where/results/are/going/to/be/placed/20210518_cabanel_coverage_db.csv or /dir/where/results/are/going/to/be/placed/20210726_dali_KiboEvRhRun1_db.csv
