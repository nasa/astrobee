...
echo "  sci cam:                 $(apk_version gov.nasa.arc.astrobee.android.scicam)"
echo "  set wallpaper:           $(apk_version gov.nasa.arc.astrobee.set_wallpaper)"
echo "  wifi setup helper:       $(apk_version gov.nasa.arc.irg.astrobee.wifisetup)"
echo "  battery monitor:         $(apk_version gov.nasa.arc.irg.astrobee.battery_monitor)"
