...
def generate_launch_description():
    return LaunchDescription([
        ...
        launch_arg("honey_pose",  default_value="0.5 0.0 0.7 3.14 0 0",  description="Overwrite honey's pose"),
        launch_arg("bumble_pose", default_value="1.0 1.0 0.7 3.14 0 0",  description="Overwrite bumble's pose"),
