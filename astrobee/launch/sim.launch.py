...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            launch_arg(
                "robot",
                default_value=os.getenv("ASTROBEE_ROBOT", "sim"),
                description="Robot name",
            ),
            launch_arg(
                "world",
                default_value=os.getenv("ASTROBEE_WORLD", "iss"),
                description="World name",
            ),
            launch_arg("ns", default_value="", description="Robot namespace prefix"),
            launch_arg(
                "output", default_value="log", description="Where nodes should log"
            ),
            launch_arg(
                "spurn", default_value="", description="Prevent a specific node"
            ),
            ...
            launch_arg(
                "physics", default_value="ode", description="Choose physics engine"
            ),
            ...
            launch_arg(
                "gtloc", default_value="false", description="Use Ground Truth Localizer"
            ),
            launch_arg(
                "perch",
                default_value="false",
                description="Start in the perch position",
            ),
            # General options
            launch_arg(
                "gviz", default_value="false", description="Start GNC visualizer"
            ),
            launch_arg(
                "rviz", default_value="false", description="Start Rviz visualization"
            ),
            launch_arg(
                "sviz", default_value="false", description="Start Gazebo visualization"
            ),
            launch_arg(
                "rqt", default_value="false", description="Start user interface"
            ),
            ...
            launch_arg(
                "stats", default_value="false", description="Message statistics"
            ),
            # Debug-specific options
            launch_arg(
                "default_robot",
                default_value="true",
                description="Insert default robot ",
            ),
            ...
            launch_arg(
                "pose",
                default_value="9.816 -9.806 4.293 0 0 0 1",
                condition=LaunchConfigurationEquals("world", "iss"),
            ),
            launch_arg(
                "pose",
                default_value="0 0 -0.7 0 0 0 1",
                condition=LaunchConfigurationEquals("world", "granite"),
            ),
            # Multi-robot simulation
            launch_arg(
                "honey", default_value="false", description="Insert honey robot"
            ),
            launch_arg(
                "bumble", default_value="false", description="Insert bumble robot"
            ),
            launch_arg(
                "queen", default_value="false", description="Insert queen robot"
            ),
            launch_arg(
                "honey_pose",
                default_value="11 -7 4.8 0 0 0 1",
                description="Use to overwrite honey's pose",
            ),
            launch_arg(
                "bumble_pose",
                default_value="11 -4 4.8 0 0 0 1",
                description="Use to overwrite bumble's pose",
            ),
            launch_arg(
                "queen_pose",
                default_value="11 -10 4.8 0 0 0 1",
                description="Use to overwrite queen's pose",
            ),
