...
class GazeboSensorPluginARTags : public FreeFlyerSensorPlugin {
 public:
  ...
  virtual ~GazeboSensorPluginARTags() {}
 ...
 protected:
  ...
  void SendRegistration(ros::TimerEvent const& event) {
    ...
    camera::CameraParameters cam_params(&config_, "dock_cam");
