...
*Note: If the package qemu-arm-static is required by the script, please install qemu-user-static.
The package multistrap is also required for the last script above.*
