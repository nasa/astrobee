...
def generate_test_description():
    ...
    return launch.LaunchDescription(
        ...
        "test_ff_action_connect_timeout": test_ff_action_connect_timeout,
    }


class TestTerminatingProcessStops(unittest.TestCase):
    def test_proc_terminates(self, proc_info, test_ff_action_connect_timeout):
        proc_info.assertWaitForShutdown(process=test_ff_action_connect_timeout, timeout=30)
