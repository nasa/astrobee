...
def generate_test_description():
    ...
    return launch.LaunchDescription(
        ...
        "test_ff_action_cancel_own_goal": test_ff_action_cancel_own_goal,
    }


class TestTerminatingProcessStops(unittest.TestCase):
    def test_proc_terminates(self, proc_info, test_ff_action_cancel_own_goal):
        proc_info.assertWaitForShutdown(process=test_ff_action_cancel_own_goal, timeout=30)
