...
def generate_test_description():
    ...
    return launch.LaunchDescription(
        ...
        "test_ff_action_active_timeout": test_ff_action_active_timeout,
    }


class TestTerminatingProcessStops(unittest.TestCase):
    def test_proc_terminates(self, proc_info, test_ff_action_active_timeout):
        proc_info.assertWaitForShutdown(process=test_ff_action_active_timeout, timeout=30)
